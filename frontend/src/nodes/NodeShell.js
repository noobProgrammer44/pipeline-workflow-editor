// NodeShell.js
// Shared visual shell for all pipeline nodes.
// Provides container, header (icon + label + settings + delete), and body wrapper.

import { useMemo } from 'react';
import { useStore } from '../store';

// ─── Shared handle style base ───────────────────────────────────────────────
...
const labelSpanStyle = { overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' };
